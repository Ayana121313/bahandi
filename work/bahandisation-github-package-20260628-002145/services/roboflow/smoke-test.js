...
async function main() {
  ...
  const mode = process.env.ROBOFLOW_API_KEY ? "live Roboflow" : "local demo";
  console.log(`${mode} smoke test passed for ${workflow.workflowId}. Output keys: ${result.outputKeys.join(", ")}`);
}
